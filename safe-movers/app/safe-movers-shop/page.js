      ...
      <div className="my-5 items-center max-w-7xl mx-auto px-6">
        ...
        <div>
          <div className="my-7">
            ...
            <p>
              <span className="font-bold italic">Variety and Durability: </span>{' '}
              Our selection includes a range of sizes and strengths to
              accommodate various items. From small, fragile items to large,
              bulky possessions, our boxes are designed to withstand the rigors
            ...
            <p>
              ...
              manufactured to the highest standards. Our boxes guarantee the
              safety of your belongings during transit or storage.
            </p>
          </div>
          <div className="my-7">
            <h2 className="text-2xl my-3 font-bold text-[#00008B]">
            ...
            <p>
              <span className="font-bold italic">Customized Solutions:</span>
              With different sizes available, we cater to diverse needs,
              allowing you to select boxes that perfectly fit your items,
              minimizing any excess space and optimizing packing efficiency.
            </p>
            <p>
          ...
          <div className="my-7">
            ...
            <p>
              <span className="font-bold italic">Residential Moves: </span>{' '}
              Safely pack your household items for a smooth transition to your
              new home.
            </p>
            <p>
            ...
            <p>
              <span className="font-bold italic">Storage Solutions: </span>{' '}
              Organize and store items securely in our durable boxes, ensuring
              they remain in pristine condition during storage.{' '}
            </p>
          </div>
          <div className="my-7">
            <h2 className="text-2xl my-3 font-bold text-[#00008B]">
            ...
            <p>
              ...
              directly to purchase our premium packing and moving carton boxes.
              Our team will assist you in selecting the right boxes based on
              your specific needs and quantities required.
            </p>
          </div>
          <div className="my-7">
            <h2 className="text-2xl my-3 font-bold text-[#00008B]">
            ...
            <p>
              ...
              carton boxes. Get in touch with us today to acquire top-quality
              boxes designed to safeguard your belongings during relocation and
              storage.{' '}
            </p>
          </div>
        </div>
