      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full h-8 border border-gray-300 shadow-sm"
            required
          />
        </div>
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full h-10 border border-gray-300 shadow-sm"
            required
          />
        </div>
        <div>
        ...
        <h2 className="text-lg space-y-4 pt-4 font-bold">Content Sections</h2>
        <div>
          <label>Heading: </label>
          <input
            type="text"
