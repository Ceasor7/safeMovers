  ...
  return (
    <header className="z-10 sticky top-0 w-full my-7 sm:my-0 flex sm:border-b sm:border-border bg-white">
      <div className="container max-w-screen-2xl sm:justify-center flex flex-col">
        <div className="flex flex-row sm:gap-x-20 sm:my-4 h-14 max-w-screen-2xl">
          <div>
            <img
          ...
          <div className="flex-row hidden md:inline-flex sm:gap-x-4">
            <Link
              href="/"
        ...
        <div className="container hidden md:inline-flex flex-row sm:gap-x-14 sm:my-2 h-14 max-w-screen-2xl items-center justify-center bg-[#00008B] hover:bg-transparent hover:text-black text-white rounded-xl">
          <Link
            href="/residential"
