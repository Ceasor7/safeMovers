  ...
  return (
    <header className="z-10 sticky top-0 w-full my-7 sm:my-0 flex sm:border-b sm:border-border bg-white">
      <div className="container max-w-screen-2xl sm:justify-center flex flex-col">
        ...
        <div className="container hidden sm:inline-flex flex-row sm:gap-x-14 sm:my-2 h-14 max-w-screen-2xl items-center justify-center bg-[#00008B] hover:bg-transparent hover:text-black text-white rounded-xl">
          <Link
            href="/residential"
