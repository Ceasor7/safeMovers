      ...
      <div className="flex flex-col sm:flex-row sm:gap-x-10">
        <div className="sm:w-2/3 flex flex-col">
          ...
          <div className="my-7">
            ...
            {/* Make this a dynamic section from gaq array, faqQuestions and faqAnswers objects */}
          ...
          <div className="my-7">
            ...
            <div className="my-7">
              <h2 className="font-bold my-3 text-lg">1. Unmatched Expertise</h2>
              <p>
              ...
              <h2 className="font-bold my-3 text-lg">3. Tailored Solutions</h2>
              <p>
